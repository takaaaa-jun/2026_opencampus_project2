...
class CrossArmsEvaluation:
    ...
    def to_payload(self) -> dict[str, object]:
        ...
        return {
            ...
            "leftAngle": self.left.angle,
            "rightAngle": self.right.angle,
            "displayLeftAngle": self.left.display_angle,
            "displayRightAngle": self.right.display_angle,
            "leftRole": self.left.role,
            "rightRole": self.right.role,
            "leftRoleOk": self.left.role_ok,
            "rightRoleOk": self.right.role_ok,
