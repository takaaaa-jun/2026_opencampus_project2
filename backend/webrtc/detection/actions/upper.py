...
class UpperEvaluation:
    ...
    def to_payload(self) -> dict[str, object]:
        ...
        return {
            ...
            "leftRisesEnough": self.left_rises_enough,
            "rightRisesEnough": self.right_rises_enough,
            "leftStartsBelowShoulder": self.left_starts_below_shoulder,
            "rightStartsBelowShoulder": self.right_starts_below_shoulder,
            "leftEndsNearOrAboveShoulder": self.left_ends_near_or_above_shoulder,
            "rightEndsNearOrAboveShoulder": self.right_ends_near_or_above_shoulder,
            "leftBetweenShoulders": self.left_between_shoulders,
            "rightBetweenShoulders": self.right_between_shoulders,
            "left": self.left.to_payload(),
            "right": self.right.to_payload(),
            "leftHand": self.left.to_payload(),
            "rightHand": self.right.to_payload(),
        }
